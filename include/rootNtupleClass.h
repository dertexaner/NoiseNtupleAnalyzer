...
// Sat Sep 27 15:52:09 2014 by ROOT version 5.32/00
// from TChain ExportTree/HcalNoiseTree/
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("ExportTree/HcalNoiseTree",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("ExportTree/HcalNoiseTree","");
      chain->Add("/tmp/hsaka/NoiseTree_54.root/ExportTree/HcalNoiseTree");
      tree = chain;
#endif // SINGLE_TREE
